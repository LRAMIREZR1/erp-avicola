    ...
    <div className="overflow-hidden rounded-2xl border border-stone-200 bg-white">
      <table className="w-full text-left text-sm">
        ...
        <tbody className="divide-y divide-stone-100">
          ...
          {productos.length === 0 && (
            <tr>
              <td colSpan={mostrarFormato ? 7 : 6} className="px-4 py-8 text-center text-stone-400">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <TablaProductos productos={bandejas} mostrarFormato={false} />
      </div>

      <div className="space-y-3">
        <h2 className="text-sm font-semibold text-stone-700">Cajas (120 / 180 un.)</h2>
        <TablaProductos productos={cajas} mostrarFormato={true} />
      </div>
    </div>
  );
}
